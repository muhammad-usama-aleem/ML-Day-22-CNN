...
training_set = train_datagen.flow_from_directory('../input/dogs-vs-cats/train',
                                                 target_size = (64, 64),
                                                 batch_size = 32,
                                                 class_mode = 'binary')

# Creating the Test set
test_set = test_datagen.flow_from_directory('../input/dogs-vs-cats/test',
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'binary')
